...
from maercbpe import BasicTokenizer, RegexTokenizer, GPT4Tokenizer
...
test_strings = [
    ...
    "FILE:works.txt", # FILE: is handled as a special string in unpack()
]
def unpack(text):
    ...
    if text.startswith("FILE:"):
        ...
        works_file = os.path.join(dirname, text[5:])
        contents = open(works_file, "r", encoding="utf-8").read()
        return contents
    else:
        return text
